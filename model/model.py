...
class City(Model):
    ...
    def setup_run_data_collection(self):
        ...
        self.log_filepath      = file_utils.get_filepath(folder_name = file_utils.output_folder, subfolder_name = "logs", file_name = f'log-{self.timestamp}.log')
        self.metadata_filepath = file_utils.get_filepath(folder_name = file_utils.output_folder, subfolder_name = "metadata", file_name = f'metadata-{self.run_id}.log')
