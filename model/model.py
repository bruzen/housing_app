...
#           "rents":                     capture_rents,
        ...
        agent_reporters      = {
            ...
            "person_vs_investor_owner":   lambda a: getattr(a, "warranted_price", None) if isinstance(a, Land) else None,
            "realized_price":   lambda a: getattr(a, "warranted_price", None) if isinstance(a, Land) else None,
        }
